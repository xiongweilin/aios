...
[![CI](https://github.com/xiongweilin/semantic-language/actions/workflows/ci.yml/badge.svg)](https://github.com/xiongweilin/semantic-language/actions/workflows/ci.yml)
...
![License](https://img.shields.io/github/license/xiongweilin/semantic-language?style=flat-square)

A small universal semantic kernel for human, institutional, and machine agency.

This repository owns cross-domain meanings and non-substitution rules. It deliberately does **not** own workflows, persistence, orchestration, domain lifecycles, or provider integrations.
