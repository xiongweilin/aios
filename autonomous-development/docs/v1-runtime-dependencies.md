...
This matches the implemented contract in `src/autonomous_development/adapters/world_runtime.py`
(`REQUIRED_RUNTIME_PROTOCOL = "4.0"`, `domain_effect_execution = "domain-effect-execution-v3"`)
and the boundary stated in the repository README. Earlier revisions of this document said
Protocol 3.0 / `domain-effect-execution-v2`; that wording was stale and is not a supported target.
