...
requirement_analyses = Table(
    ...
    Column("personal_context_projection_ref", String(160)),
    Column("personal_context_basis_refs_json", JSON, nullable=False, default=list),
    Column("personal_context_revalidation_refs_json", JSON, nullable=False, default=list),
    Column("created_at", DateTime(timezone=True), nullable=False),
)
